 ...
 */
public class PersistUserImpl implements PersistUser, Interactor {
    ...
    @Inject
    public PersistUserImpl(Executor executor,
    ...
    @Override
    public void persist(User user, Callback callback) {
